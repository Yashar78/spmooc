...
avgDailyReqPerHost = (sortedByDay
                      .map(lambda (a,b):(a,len(b)/len(set(b))) ))
...
badEndpointsTop20 = badEndpointsSum.takeOrdered(20, key=lambda (a,b):-b)
...
topErrDate = errDateSorted.takeOrdered(5, key=lambda (a,b):-b)
