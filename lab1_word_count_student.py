...
totalCount = (wordCounts
              .map(lambda (a,b): b)
              .reduce(add))
average = totalCount * 1.0 / float(wordCounts.count())
print totalCount
...
def removePunctuation(text):
    ...
    """
    text = re.sub('[^a-zA-Z\d\s]',"",text).lower()
...
# TODO: Replace <FILL IN> with appropriate code
import string
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda x:string.split(x,sep=' '))
print shakespeareWordsRDD.take(20)
